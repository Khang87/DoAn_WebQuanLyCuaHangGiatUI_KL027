    ...
    <div class="card-body">
        ...
        <form action="{{ route('bookings.update', $booking) }}" method="POST">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6"><label class="form-label">Trạng thái</label><x-admin.status-select name="status" :options="\App\Enums\BookingStatus::options()" :selected="$booking->status" class="form-select @error('status') is-invalid @enderror" />@error('status')<div class="invalid-feedback">{{ $message }}</div>@enderror</div>
