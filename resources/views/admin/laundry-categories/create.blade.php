...
@section('title', 'Thêm danh mục loại đồ - Sky Laundry')
@section('page-title', 'Thêm danh mục loại đồ')
        ...
        <form action="{{ route('laundry-categories.store') }}" method="POST">
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('code') is-invalid @enderror" name="code" value="{{ old('code', 'DM' . str_pad(1, 3, '0', STR_PAD_LEFT)) }}" required>
                    @error('code')
