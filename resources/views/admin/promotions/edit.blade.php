            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select @error('status') is-invalid @enderror" name="status">
                        <option value="active" @selected(old('status', $promotion->status) === 'active')>Đang chạy</option>
                        <option value="inactive" @selected(old('status', $promotion->status) === 'inactive')>Tắt</option>
                    </select>
                    @error('status')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
