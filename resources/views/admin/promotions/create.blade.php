        ...
        <form action="{{ route('promotions.store') }}" method="POST">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control @error('quantity') is-invalid @enderror" name="quantity" value="{{ old('quantity') }}" min="1" placeholder="Để trống = không giới hạn">
                ...
                <div class="col-12">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="conditions[first_order_only]" id="first_order_only" value="1" {{ old('conditions.first_order_only') ? 'checked' : '' }}>
