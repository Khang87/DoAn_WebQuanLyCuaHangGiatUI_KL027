            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select" name="type">
                        <option value="Mới" @selected($customer->type === 'Mới')>Mới</option>
                        <option value="Thường" @selected($customer->type === 'Thường')>Thường</option>
                        <option value="VIP" @selected($customer->type === 'VIP')>VIP</option>
                    </select>
                </div>
                <div class="col-12">
